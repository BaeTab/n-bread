...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] text-gray-900 font-sans selection:bg-indigo-100 selection:text-indigo-800">
      <div className="max-w-7xl mx-auto p-4 md:p-8">
        {/* Header for Mobile */}
        <div className="mb-6 md:hidden">
          <h1 className="text-2xl font-black text-gray-900 tracking-tight">🧾 N-BREAD</h1>
          <p className="text-gray-500 text-sm">더치페이 영수증 생성기</p>
        </div>
